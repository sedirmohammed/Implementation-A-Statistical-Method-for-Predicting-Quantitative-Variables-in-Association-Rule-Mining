...
for (minsup_border in minsup_borders){
  for (x in 1:top_n) {
    ...
    for (resample in 1:10000) {
      ...
      set <- read.csv(paste0("../results/scenario2/mimic/los__",x,"__",minsup_border,"__set","/part-00000"))
      ...
      counter_set <- read.csv(paste0("../results/scenario2/mimic/los__",x,"__",minsup_border,"__counter_set","/part-00000"))
